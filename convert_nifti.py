...
if __name__ == "__main__":
    input_folder = "data/manifest-1724965242274/Spine-Mets-CT-SEG"  # Replace with the path to the input folder
    output_folder = "data/Spine-Mets-CT-SEG-Nifti"  # Replace with the path for the output
    path_to_segimage2itkimage = "/home/wallace/Downloads/dcmqi-1.5.2-linux/bin/segimage2itkimage"  # Replace with the actual path to segimage2itkimage
